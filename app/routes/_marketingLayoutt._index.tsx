...
export function meta() {
  return [
    {
      title: "Expense Tracker | Manage & Analyze Your Finances",
      description: "Track your expenses and gain insights into your spending habits with powerful analytics and a user-friendly interface."
    }];
}
